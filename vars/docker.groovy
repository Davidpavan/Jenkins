        ...
        stages{
                ...
                steps{
                    script {
                     ...
                     sh '''
                       ...
                       docker build -t 808790164949.dkr.ecr.us-east-1.amazonaws.com/${COMPONENT}:${get_branch_exec} .
                     '''
            ...
            stage('Docker push'){
                steps{
                    ...
                    sh '''
                       docker push 808790164949.dkr.ecr.us-east-1.amazonaws.com/${COMPONENT}:${get_branch_exec}
                     '''
